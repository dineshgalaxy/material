...
const Header = () => {
    ...
    return (
        <>
            <Box component="header" position="relative" py={2} bgcolor="#313d4d">
                <Container>
                    <Grid container flexDirection="row" justifyContent="space-between" alignItems="center" >
                        ...
                        <Box alignItems="center" className={classes.menu} display="flex">
                            {
                                Menu.map((value) => {
                                    return (
                                        <Box
                            ...
                            <Box>
                                <Button variant="outlined" color="error" className={classes.headerBtn}>
                                    Contact
                                </Button>
                            </Box>
                        </Box>
