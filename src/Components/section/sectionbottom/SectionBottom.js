...
const SectionBottom = () => {
    ...
    return (
        <>
            <Box py={6} bgcolor="grey.main">
                <Container>
                    <Grid container spacing={3} alignItems="center">

                        <Grid item xs={12} sm={6} md={5} lg={5} fontSize={34}>
                            <Typography variant="h2" fontSize={34} gutterBottom>
                            ...
                            <Button className={classes.btn} variant="outlined" mt={3}  endIcon={<PlayArrowIcon/>}>
                            Watch our video
                            </Button>
                        </Grid>
                        <Grid item xs={12} sm={6} md={7} lg={7} >
                          <Box className="playBtn" display="flex" alignItems="center" justifyContent="center">
