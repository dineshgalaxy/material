...
import montStreet from '../../../Fonts/montserrat/Montserrat-Light.otf'
const SectionTop = () => {
    return (
        <>
            <Box className="section" py={8} >
                <Container>
                    <Grid container spacing={3} alignItems="center">

                        <Grid item xs={12} sm={6} md={5} lg={5} fontSize={34} fontFamily={montStreet}>
                            <Typography variant="h2" fontSize={34} gutterBottom color="error">
                                Our mission is to create purposeful connections through technology
                            </Typography>
